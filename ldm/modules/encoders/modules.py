...
class ClassEmbedder(nn.Module):
    ...
    def get_unconditional_conditioning(self, bs, device="cuda" if torch.cuda.is_available() else "cpu"):
...
class FrozenT5Embedder(AbstractEncoder):
    ...
    def __init__(self, version="google/t5-v1_1-large", device="cuda" if torch.cuda.is_available() else "cpu", max_length=77,
